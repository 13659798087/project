...
public class LogManagementServices {
    ...
    public List<LogManagement> getLogger(int pageNo,int pageSize,Timestamp time_1,Timestamp time_2, String loggerName,
                                         String patients,String barcode,String hospital,String combine,String type,String p_tel1) {
        return logManagementDao.getLogger(pageNo,pageSize,time_1,time_2,loggerName,patients,barcode,hospital,combine,type,p_tel1);
    }

    public long getLoggerCount(int pageNo,int pageSize,Timestamp time_1,Timestamp time_2, String loggerName,
                               String patients,String barcode,String hospital,String combine,String type,String p_tel1) {
        return logManagementDao.getLoggerCount(pageNo,pageSize,time_1,time_2,loggerName,patients,barcode,hospital,combine,type,p_tel1);
    }
